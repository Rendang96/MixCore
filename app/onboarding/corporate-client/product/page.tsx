...
export default function ProductStep() {
  ...
  const handleSave = () => {
    // Save logic here
    console.log("Saving product data:", formData.product)
    // Navigate to next step
    router.push("/onboarding/corporate-client/policy")
  }
      ...
      <div className="mb-6">
        <PageBreadcrumbs
          items={[
            ...
            { label: "Product", href: "/onboarding/corporate-client/product" },
          ]}
        />
      </div>
        ...
        <div className="flex-1 bg-white p-12">
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              <p>Product selection form will go here</p>
            </div>

            <div className="flex justify-between gap-3 mt-12">
              <button
                onClick={() => router.push("/onboarding/corporate-client/payor")}
