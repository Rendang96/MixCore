...
import { CorporateClientViewForm } from "@/components/onboarding/corporate-client-view-form"

export default function ViewCorporateClientPage() {
  ...
  return <CorporateClientViewForm client={client} />
}
