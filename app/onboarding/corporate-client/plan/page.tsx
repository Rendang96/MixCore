...
export default function PlanStep() {
  ...
  const handleSave = () => {
    // Save logic here
    console.log("Saving plan data:", formData.plan)
    // Navigate to next step
    router.push("/onboarding/corporate-client/provider")
  }
      ...
      <div className="mb-6">
        <PageBreadcrumbs
          items={[
            ...
            { label: "Plan", href: "/onboarding/corporate-client/plan" },
          ]}
        />
      </div>
        ...
        <div className="flex-1 bg-white p-12">
          <div className="space-y-8">
            ...
            <div className="flex justify-between gap-3 mt-12">
              <button
                onClick={() => router.push("/onboarding/corporate-client/policy")}
