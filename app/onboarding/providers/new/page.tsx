...
export default function NewOnboardingProviderPage() {
  const router = useRouter()
  const [isSubmitting, setIsSubmitting] = useState(false)
  // Ensure the form data is properly initialized as empty
  ...
  // Update the handleSubmit function to ensure proper status setting and redirection
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <PageHeader title="New Onboarding Provider" description="Create a new provider for onboarding" />
